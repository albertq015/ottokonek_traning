package com.otto.mart.ui.activity.ppob.product.topUp
...
class PpobTopUpProductInputActivity : PpobActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ppob_top_up_product_input)
    ...
    private fun initView() {
        ...
        tvSelectProvider.text = getString(R.string.ppob_label_select_wallet)
        btnFavorite.gone()
