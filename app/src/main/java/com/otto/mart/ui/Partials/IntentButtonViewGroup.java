...
import com.otto.mart.ui.Partials.adapter.DashboardIconAdapter;

import java.util.List;

public class IntentButtonViewGroup extends LinearLayout {
    ...
    public IntentButtonViewGroup(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public void initWidget(Activity parent, List<DashboardIconModel> models, int rows) {
        ...
        DashboardIconAdapter adapter = new DashboardIconAdapter(parent, cLayout, models);
