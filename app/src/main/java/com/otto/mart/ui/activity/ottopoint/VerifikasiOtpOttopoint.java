...
public class VerifikasiOtpOttopoint extends AppCompatActivity {

    private String TAG = VerifikasiOtpOttopoint.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verifikasi_otp_ottopoint);
        ...
        pinview.setPinViewEventListener((pinview, fromUser) -> {
            if(pinview.getValue().length() == 4){
                // hide soft keyboard
                CommonHelper.hideKeyboard(VerifikasiOtpOttopoint.this);
    ...
    private void moveToDashboard(){
        //DashboardActivity.openPage(VerifikasiOtpOttopoint.this, DashboardActivity.TYPE_RESPONSE_SUCCESS_REGISTER_OTTOPOINT);
    }
}
