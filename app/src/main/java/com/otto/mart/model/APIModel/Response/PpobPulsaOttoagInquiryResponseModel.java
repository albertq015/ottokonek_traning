...
import com.otto.mart.model.APIModel.Misc.PulsaOttoagDataModel;
import com.otto.mart.model.APIModel.Misc.WidgetBuilderModel;
import com.otto.mart.model.APIModel.Response.BaseModel.BaseResponseModel;

import java.util.List;

public class PpobPulsaOttoagInquiryResponseModel extends BaseResponseModel {

    PpobPulsaOttoagInquiryData data;

    public PpobPulsaOttoagInquiryData getData() {
        return data;
    }

    public void setData(PpobPulsaOttoagInquiryData data) {
        this.data = data;
    }
    ...
    public List<PulsaOttoagDataModel> getList_detail() {
        return data.list_detail;
    }

    public void setList_detail(List<PulsaOttoagDataModel> list_detail) {
...
class PpobPulsaOttoagInquiryData {
    String rc;
    String rrn;
    int adminfee;
    int amount;
    ...
    String productcode;
    String uimsg;
    List<PulsaOttoagDataModel> list_detail;
